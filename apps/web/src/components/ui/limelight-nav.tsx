 ...
 * the active item. The active item is rendered at full opacity; the others
 * dim to 40%. A glowing bar at the top slides between items via a CSS
 * transition on `left`.
 */
export const LimelightNav = ({
  ...
  return (
    <nav
      className={`relative inline-flex items-center h-16 rounded-lg bg-card text-foreground border px-2 ${
        className ?? ''
      }`}
    >
